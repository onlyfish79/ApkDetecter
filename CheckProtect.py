...
class CheckProtect():
    ...
    def check_protectflag(self):
        ...
        activites = self.getactivity(self.unzipPath)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print '%s apkPath' % sys.argv[0]
        sys.exit(0)
    apkPath = sys.argv[1]
    checkObj = CheckProtect(apkPath)
    print checkObj.check_protectflag()
